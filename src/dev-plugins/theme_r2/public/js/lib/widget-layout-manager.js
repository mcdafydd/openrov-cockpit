$(document).ready(function () {
  ...
  Object.keys(wid).forEach(function (section) {
    for (var i in wid[section]) {
      ...
      link.href = 'components/' + wid[section][i]._linkhref;
      link.rel = 'import';
      link.async = false;
...
*/
  window.addEventListener('WebComponentsReady', function (e) {
    ...
    var addelement = function (document, area, elementDefinition) {
      ...
      link.rel = 'import';
      link.async = false;
      document.head.appendChild(link);  //        for (var l in el.properties){
