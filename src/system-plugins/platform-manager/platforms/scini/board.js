...
class BoardInterface
{
  ...
  Compose( platform )
  {
    ...
    console.log( 'BOARD: Composing SCINI board interface...' );
  ...
  LoadInfo()
  {
    ...
    console.log('BOARD: Loading board info filesystem...');

    return fs.readFileAsync( path.resolve( __dirname, 'boards/surface/eeprom.json' ), 'utf8' )
      .then( JSON.parse )
      .then( (info) =>
      {
